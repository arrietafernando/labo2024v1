...
envg$EXPENV <- list()
envg$EXPENV$dir <- "~/buckets/b1/exp3-base2/"
envg$EXPENV$exp_dir <- "~/buckets/b1/exp3-base2/exp/"
envg$EXPENV$wf_dir <- "~/buckets/b1/exp3-base2/flow/"
envg$EXPENV$wf_dir_local <- "~/flow/"
envg$EXPENV$repo_dir <- "~/labo2024v1/"
envg$EXPENV$datasets_dir <- "~/buckets/b1/datasets/"
envg$EXPENV$arch_sem <- "mis_semillas_MCV.txt"
